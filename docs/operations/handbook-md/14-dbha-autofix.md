...
切换成功/失败会向蓝鲸监控上报自定义事件（与 [第 13 章告警策略](13-performance-views.md#13-6-mongodb-告警策略) 对应）：
...
工单常量见 [第 4 章 §4.7](04-tickets.md#4-7-插件与观测-4-项)。
...
| 来源                     | 说明                                                              |
| ---------------------- | --------------------------------------------------------------- |
| **DBHA 事件告警**          | [第 13 章告警策略](13-performance-views.md#13-6-mongodb-告警策略)      |
