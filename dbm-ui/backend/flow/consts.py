...
MysqlVersionToDBBackupForMap = {
    ...
    "MySQL-8.0": MediumEnum.DbBackupTXSQL if env.MYSQL_BACKUP_PKG_MAP_ENABLE else MediumEnum.DbBackup,
    "TXSQL-8.0": MediumEnum.DbBackupTXSQL,
    "TenDB-8.0": MediumEnum.DbBackupTXSQL,
    "MySQL-5.6-TokuDB": MediumEnum.DbBackupTXSQL,
