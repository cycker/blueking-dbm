        ...
        v = {
            ...
            "db_act_template": {
                ...
                "payload": {
                    ...
                    "toolkit_pkg": {
                        "pkg": pkg_info["toolkit_pkg"].path,
                        "pkg_md5": pkg_info["toolkit_pkg"].md5,
                    },
...
class PrepareInstanceInfo(BaseSubTask):
    @classmethod
    def make_kwargs(
        cls, iplist: List[str], bk_cloud_id: int, file_path: str, pkg_info: Dict, bk_monitor_beat_config: Dict
    ) -> dict:
        return {
            "set_trans_data_dataclass": CommonContext.__name__,
            "get_trans_data_ip_var": None,
            "trans_data_var": {
                "iplist": iplist,  # 用于 trans_data
                "bk_cloud_id": bk_cloud_id,
            },
            "db_act_template": {
                "action": MongoDBActuatorActionEnum.InstallDBMon.value,
