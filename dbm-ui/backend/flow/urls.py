...
urlpatterns = [
    ...
    url(r"^scene/redis_cluster_ins_migrate$", RedisClusterInsMigrateApiView.as_view()),
    url(r"^scene/redis_single_ins_migrate$", RedisSingleInsMigrateApiView.as_view()),
